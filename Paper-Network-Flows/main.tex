...
\newcommand{\rqa}{What is the performance of ML algorithms for malware classification using the \droidxpflow approach?}

\newcommand{\rqb}{How much gain we obtain on the malware classification accuracy when we combine the \mas and \droidxpflow?}

\newcommand{\rqc}{How effective is \droidxpflow at correctly classifying malware families where the \mas approach demonstrated poor performance?}
...
\IEEEcompsocthanksitem F. Costa, R. Valera, R. Bonif\'{a}cio, E. Monteiro and J. Gondim are with the 
