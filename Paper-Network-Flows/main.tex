...
\newcommand{\ml}{Machine Learning process\xspace}
...
\newcommand{\rqa}{Can the use of machine learning technology using network traffic data to improve the accuracy of \mas for malware identification ?}

\newcommand{\rqb}{Which algorithms are effective to be used for training models base on network traffic data for malware identification?}

\newcommand{\rqc}{Which  malware family (e.g., \fm{gappusin}, \fm{kuguo}, \fm{dowgin}) the Flow Analysis has the best performance on alone, and with \mas support for malware identification?}
...
\title{Complementing Mining Android Sandbox Approach with Network Flows for Malware Identification}


\author{Francisco Costa,
        Rodrigo~Bonif\'{a}cio
\IEEEcompsocitemizethanks{
\IEEEcompsocthanksitem F. Costa and R. Bonif\'{a}cio are with the 
Computer Science Department, University of Bras\'{i}lia, Bras\'{i}lia, Brazil.
E-mail: \{francisco.costa\}@aluno.unb.br and \{rbonifacio\}@unb.br.
...
\markboth{IEEE Transactions on Software Engineering,~Vol.~XX, No.~X, April~XXXX}%
